# =============================================================================
# Protego — FastAPI Server (Text-Only Detection)
# =============================================================================
# MOCK_MODE = True  → simulated predictions
# MOCK_MODE = False → loads real trained model from scam_model/
#
# Run:
#   cd C:\protego_project\api
...
if not MOCK_MODE:
    try:
        ...
        model = TextOnlyScamDetector(bert_model_name="bert-base-multilingual-cased")
...
app = FastAPI(
    title="Protego API",
    description="Text-only Taglish scam detection — mBERT",
    version="1.0.0"
)
...
def mock_predict(req: PredictRequest) -> dict:
    ...
    scam_keywords = [
        ...
        "pay", "money", "cash", "bank", "transfer", "wallet"
    ]
